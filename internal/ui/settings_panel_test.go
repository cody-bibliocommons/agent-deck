...
func TestSettingsPanel_LoadConfig_CustomTools(t *testing.T) {
	...
	wantNames := []string{"Claude", "Gemini", "OpenCode", "Codex", "Pi", "Copilot", "Crush", "Cursor", "Hermes", "DeepSeek", "Kiro CLI", "Openclaw", "Zeta", "None"}
	wantValues := []string{"claude", "gemini", "opencode", "codex", "pi", "copilot", "crush", "cursor", "hermes", "deepseek", "kiro-cli", "openclaw", "zeta", ""}
